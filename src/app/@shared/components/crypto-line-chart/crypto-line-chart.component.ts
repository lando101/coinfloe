...
export class CryptoLineChartComponent implements OnChanges {
  ...
  //   '1d': {
  //     xaxis: {
  //       min: new Date(moment().subtract(1, 'day').format('DD MMM YYYY')).getTime(),
  //       max: new Date(moment().format('DD MMM YYYY')).getTime(),
  //     },
  //   },
  //   '7d': {
  //     xaxis: {
  //       min: new Date(moment().subtract(7, 'day').format('DD MMM YYYY')).getTime(),
  //       max: new Date(moment().format('DD MMM YYYY')).getTime(),
  //     },
  //   },
  //   '30d': {
  //     xaxis: {
  //       min: new Date(moment().subtract(30, 'day').format('DD MMM YYYY')).getTime(),
  //       max: new Date(moment().format('DD MMM YYYY')).getTime(),
  //     },
  //   },
  //   '6m': {
  //     xaxis: {
  //       min: new Date(moment().subtract(6, 'month').format('DD MMM YYYY')).getTime(),
  //       max: new Date(moment().format('DD MMM YYYY')).getTime(),
  //     },
  //   },
  //   '1yd': {
